...
export default function LanguageSwitcher() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className={`fi fi-${localeFlagIcons[locale as Locale]} text-xl`} style={{ fontSize: '1.5rem' }}></span>
        <span className="font-medium text-gray-700">{localeNames[locale as Locale]}</span>
        <svg
        ...
        <>
          ...
          <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-lg shadow-lg z-20 max-h-96 overflow-y-auto">
            {locales.map((loc) => (
              ...
              >
                <span className={`fi fi-${localeFlagIcons[loc]}`} style={{ fontSize: '1.75rem' }}></span>
